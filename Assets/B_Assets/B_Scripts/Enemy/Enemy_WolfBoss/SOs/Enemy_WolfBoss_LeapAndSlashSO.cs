...
[CreateAssetMenu(fileName = "Enemy_WolfBoss_LeapAndSlashSO", menuName = "EnemyActionSO/Enemy_WolfBossActionSO/Enemy_WolfBoss_LeapAndSlashSO")]
public class Enemy_WolfBoss_LeapAndSlashSO : Enemy_WolfBossActionSO
{
    ...
    public override void Execute(EnemyAnimatorController animator)
    {
        ...
        animator.SetTriggerAnim(EnemyAnimatorController.AnimationBase.WolfBoss_LeapAndSlash);
    }
}
